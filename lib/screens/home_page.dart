...
//      .getProviceProvider(_selectedLocation);
  ...
  Widget build(BuildContext context) {
    ...
    var home = Provider
        ...
        .home;
    var daily = Provider
        .of<DailyProvider>(context)
        .daily;
    var province = Provider
        .of<ProvinceProvider>(context)
        .province;
    var country = Provider
        .of<CountryProvider>(context)
        .country;
    ...
    return RefreshIndicator(
      ...
      child: Scaffold(
          ...
          body: Container(
              ...
              child: home != null && daily != null ? ListView(
                children: <Widget>[
                  if (home != null)
                    Column(
                      children: <Widget>[
                        ...
                        titleWidget('Recovered',
                            ...
                            AppStyle.txg),
                        titleWidget(
                            'Deaths', nf.format(home?.deaths?.value) ?? '',
                            AppStyle.txr),
                      ],
                    ),
                  SizedBox(height: 20),
